...
if(isset($_POST['add_meal'])){
    echo "Form submitted successfully.<br>"; // Debugging statement

    // Output the values received from the form
    echo "Meal: ".$_POST['meal']."<br>";
    echo "Quantity: ".$_POST['quantity']."<br>";
    echo "Calories: ".$_POST['calories']."<br>";
    ...
    $insert=mysqli_query($connection,"INSERT INTO `track` (`meal`, `quantity`, `calories`) VALUES ('$meal', '$quantity', '$calories')") or die(mysqli_error($connection));
        ...
        <section class="wrapper">
            ...
            <div class="calories">
                <div class="total-calories">
                    <h2>Total Calories: </h2><span class="calories-result">0</span>
                </div>
                <div class="line"></div>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="card-input">
                            <input type="text" name="Meal" id="meal-input" placeholder="Meal">
                            <input type="number" name="Quantity" id="quantity-input" placeholder="Quantity(gm)">
                            <input type="number" name="Calories" id="calorie-input" placeholder="Calories">
                        </div>
                        
                        <div class="card-button">
                            <button class="add-meal-btn" name="add_meal"><i class="fa-solid fa-plus"></i></button>
                        </div>
                ...
                <div class="line"></div>
                <a href="file:///C:/Users/hp/Downloads/NutritiveValueofFoods.pdf"></a>
